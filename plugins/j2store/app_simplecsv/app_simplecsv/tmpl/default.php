...
<div class="alert alert-block alert-warning">
	...
	<p><?php echo JText::_('J2STORE_SIMPLE_CSV_WARNING_MESSAGE'); ?></p>
</div>
<div class="alert alert-block alert-info">
<strong><?php echo JText::_('J2STORE_SIMPLE_CSV_INSTRUCTIONS')?></strong>:
	<ol>
...
<form class="form-horizontal form-validate" id="adminForm" 	name="adminForm" method="post" action="index.php" enctype="multipart/form-data">
	<?php echo  J2Html::hidden('option','com_j2store');?>
		...
		<div class="row-fluid">
			...
			<div class="span6" id="simple-csv-container">
                <div class="control-group form-inline">
                    <label class="control-label">
                        <?php echo JText::_('PLG_J2STORE_APP_SIMPLECSV_CHOOSE_IMPORT_TYPE');?>
                    </label>
                    <div class="controls">
                        <fieldset >
                            <input id="importtype0" type="radio" name="importtype" value="file">
                            <label for="importtype0" ><?php echo JText::_('PLG_J2STORE_SIMPLE_CSV_IMPORT_TYPE_FILE')?></label>
                            <input id="importtype1" type="radio" name="importtype" value="path">
                            <label for="importtype1" ><?php echo JText::_('PLG_J2STORE_SIMPLE_CSV_IMPORT_TYPE_PATH')?></label>
                        </fieldset>
                    </div>
                </div>
            </div>
				...
				<div id="input-file" class="control-group" style="display:none;">
					<label class="control-label">
						<?php echo JText::_('PLG_J2STORE_APP_SIMPLECSV_IMPORT_FILE');?>
					</label>
					<div class="controls">
						<input type="file" name="csvdata" id="importCsv" /> <?php echo JTExt::_('PLG_J2STORE_APP_SIMPLE_CSV_MAX_SIZE_HELP');?>
					</div>
				</div>

				<div id="input-path" class="control-group" style="display:none;">
					<label class="control-label">
						<?php echo JText::_('PLG_J2STORE_APP_SIMPLECSV_ENTER_FILEPATH');?>
					</label>
					<div class="controls">
				...
				<div class="control-group form-inline">
					<label class="control-label">
						<?php echo JText::_('PLG_J2STORE_APP_SIMPLECSV_CHARSET');?>
					</label>
				...
				<div class="control-group form-inline">
					<label class="control-label">
						<?php echo JText::_('PLG_J2STORE_APP_SIMPLECSV_OVERWRITE_PRODUCT_IF_SKU_MATCHES');?>
					</label>
						<?php echo JHtmlSelect::booleanlist('overwrite',array('class'=>'inline'));?>
				</div>
				<div class="control-group">
					<div class="controls">
						<input class="btn btn-success" onclick="jQuery('#appTask').attr('value','importCsv'); jQuery(this).attr('disable', 'disable');"  type="submit"  value="<?php echo JText::_('J2STORE_IMPORT');?>" />
					</div>
				</div>
			</div>
			<div class="span6">
				<div class="alert alert-block alert-warning">
					<?php echo JText::_('J2STORE_SIMPLE_CSV_EXPORT_DATA_HELP_TEXT'); ?>
					<br />
...
(function($) {
	...
	$(document).on('click', '#simple-csv-container input[name=\'importtype\']', function() {
	...
	$('#simple-csv-container label[for=\'importtype0\']').trigger('click');
