...
class J2StoreControllerAppSimplecsv extends J2StoreAppController
{



	var $_element   = 'app_simplecsv';
	...
	public function importCsv(){
		$this->includeCustomModel('AppSimpleCsv', 'J2StoreModel');
		$model = F0FModel::getTmpInstance('AppSimpleCsv', 'J2StoreModel');
		...
		switch ($type) {
			...
			$msg = JText::_('J2STORE_SIMPLE_CSV_IMPORT_SUCCESSFUL');
			$msgType = 'success';
		} catch (Exception $e) {
			$msg = $e->getMessage();
			$msgType ='warning';
