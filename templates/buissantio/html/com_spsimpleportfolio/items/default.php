			...
			<div class="portfolio-img">
					<img class="sp-simpleportfolio-img" src="<?php echo $this->item->thumb; ?>" alt="<?php echo $this->item->title; ?>">
								...
								<div class="simpleportfolio-btns">
									<?php if( $this->item->video ) : ?>
										<a class="btn-zoom" href="#" data-featherlight="#sp-simpleportfolio-video<?php echo $this->item->id; ?>"><i class="fas fa-search"></i></a>
									<?php else: ?>
										<a class="btn-zoom" href="<?php echo $this->item->popup_img_url; ?>" data-featherlight="image"><i class="fas fa-search"></i></a>
									<?php endif; ?>
								</div>
			</div>
