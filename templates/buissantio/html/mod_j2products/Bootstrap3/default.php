				...
				<div itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product" class="j2store product-<?php echo $product->j2store_product_id; ?> j2store-module-product j2store-single-product">
					...
					<!-- end intro text -->					
						...
						if($product->image_position == 'top'){
							$img_class = ' j2store-product-images ';
						}else {
							$img_class = 'j2store-product-images';
						}
						?>
								...
								<?php if($j2params->get('catalog_mode', 0) == 0 ): ?>
									<form action="<?php echo $product->cart_form_action; ?>"
										...
										<?php elseif( $product->product_type=='configurable' || ($cart_type == 2 && count($product->options)) || $cart_type==3 ):?>
											...
											<a href="<?php echo $product->module_display_link; ?>" class="sppb-btn sppb-btn-primary j2store-button-cart <?php echo $params->get('choosebtn_class', 'btn btn-success'); ?>"><?php echo JText::_('J2STORE_VIEW_PRODUCT_DETAILS'); ?></a>
