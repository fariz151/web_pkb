...
?>
	<div class="woocommerce-tabs">
			<ul class="nav nav-tabs" id="j2store-product-detail-tab">
				...
				if($this->params->get('item_show_sdesc') || $this->params->get('item_show_ldesc')):?>
					<li class="<?php echo isset($set_specification_active) && $set_specification_active ? 'active' : '';?>"><a href="#description" data-toggle="tab"><?php echo JText::_('J2STORE_PRODUCT_DESCRIPTION')?></a>
				<?php endif;?>
