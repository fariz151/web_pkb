				...
				$output .= '<div class="sppb-article-info-wrap">';
					...
					if($show_author || $show_category || $show_date) {
						...
						if($show_author) {
							...
							$output .= '<span class="sppb-meta-author" itemprop="name"><i class="fa fa-user-circle text-secondary"></i>' . $author . '</span>';
						}

						if($show_date) {
							$output .= '<span class="sppb-meta-date" itemprop="datePublished"><i class="fa fa-calendar-alt text-secondary"></i>' . Jhtml::_('date', $item->publish_up, 'DATE_FORMAT_LC3') . '</span>';
						}
